...
copy zig-cache\bin\virtualxt.exe %PACKAGE_DEST%
...
rem copy boot\freedos_hd.img %PACKAGE_DEST%\boot
copy tools\package\itch\itch.windows.toml %PACKAGE_DEST%\.itch.toml

copy zig-cache\bin\virtualxt.exe %PACKAGE_DEST%\virtualxt-net.exe
